        ...
        this.actions = [
            {
                ...
                show: () => 
                    this.module === 'CSEQA' ? userPermissions.includes(Permission.EXTERNAL_REVIEWERS_CANDIDATES_CSEQA_VIEW_DETAILS) : 
                    this.module === 'CHEQA' ? userPermissions.includes(Permission.EXTERNAL_REVIEWERS_CANDIDATES_CHEQA_VIEW_DETAILS) :
                    this.module === 'OQF' ? userPermissions.includes(Permission.EXTERNAL_REVIEWERS_CANDIDATES_OQF_VIEW_DETAILS) : false
            }
        ];
    }
