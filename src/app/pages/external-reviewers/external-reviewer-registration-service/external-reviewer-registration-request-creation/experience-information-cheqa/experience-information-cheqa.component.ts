...
@Component({
    selector: 'app-experience-information-cheqa',
    templateUrl: './experience-information-cheqa.component.html',
    styleUrl: './experience-information-cheqa.component.scss'
})
export class ExperienceInformationCheqaComponent implements OnInit {

    @ViewChild('cheqaForm') cheqaForm?: NgForm;
    ...
    ngOnInit(): void {
        ...
        this.selectedFileName = this.externalReviewersRegistrationRequestInfo.cheqaExperience.resumeFileName || "";
        ...
        this.commonService.uploadFileToOci(bucket, this.selectedFile)
            .subscribe({
                next: (response) => {
                    ...
                    this.externalReviewersRegistrationRequestInfo.cheqaExperience.resumeBucketName = response.data.bucketName;
                    this.externalReviewersRegistrationRequestInfo.cheqaExperience.resumeFileName = response.data.objectName;
