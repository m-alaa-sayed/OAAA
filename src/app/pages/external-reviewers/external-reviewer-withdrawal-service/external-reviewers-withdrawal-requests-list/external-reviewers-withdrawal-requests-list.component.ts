    ...
    this.actions = [
      {
        ...
        show: () => 
          this.module == 'CSEQA' ? userPermissions.includes(Permission.CSEQA_ER_Withdraw_Request_VIEW_DETAIL) : 
          this.module == 'CHEQA' ? userPermissions.includes(Permission.CHEQA_ER_Withdraw_Request_VIEW_DETAIL) : 
          this.module == 'OQF' ? userPermissions.includes(Permission.OQF_ER_Withdraw_Request_VIEW_DETAIL) : false
    }
    ];
  }
