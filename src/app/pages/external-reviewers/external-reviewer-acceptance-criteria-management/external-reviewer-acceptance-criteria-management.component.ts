...
export class ExternalReviewerAcceptanceCriteriaManagementComponent implements OnInit, OnDestroy {
    ...
    permissionErAcceptanceCriteriaUpdate! : Permission;
    permissionErAcceptanceCriteriaDelete! : Permission;
    permissionErAcceptanceCriteriaView! : Permission;
    permissionErAcceptanceCriteriaAdd! : Permission;
        ...
        this.actions = [
            {
                ...
                show: () => userPermissions.includes(this.permissionErAcceptanceCriteriaUpdate)
            },
            {
                ...
                show: () => userPermissions.includes(this.permissionErAcceptanceCriteriaDelete)
            },
            {
                ...
                show: () => userPermissions.includes(this.permissionErAcceptanceCriteriaView)
            }
        ];
    }
    ...
    ngOnInit(): void {
        this.route.paramMap.subscribe(params => {
            ...
            this.permissionErAcceptanceCriteriaUpdate = 
            this.module === 'CSEQA' ? Permission.CSEQA_ER_Acceptance_CRITERIA_UPDATE : 
            this.module === 'CHEQA' ? Permission.CHEQA_ER_Acceptance_CRITERIA_UPDATE : Permission.OQF_ER_Acceptance_CRITERIA_UPDATE;

            this.permissionErAcceptanceCriteriaDelete = 
            this.module === 'CSEQA' ? Permission.CSEQA_ER_Acceptance_CRITERIA_DELETE : 
            this.module === 'CHEQA' ? Permission.CHEQA_ER_Acceptance_CRITERIA_DELETE : Permission.OQF_ER_Acceptance_CRITERIA_DELETE;

            this.permissionErAcceptanceCriteriaView = 
            this.module === 'CSEQA' ? Permission.CSEQA_ER_Acceptance_CRITERIA_VIEW : 
            this.module === 'CHEQA' ? Permission.CHEQA_ER_Acceptance_CRITERIA_VIEW : Permission.OQF_ER_Acceptance_CRITERIA_VIEW;

            this.permissionErAcceptanceCriteriaAdd = 
            this.module === 'CSEQA' ? Permission.CSEQA_ER_Acceptance_CRITERIA_ADD : 
            this.module === 'CHEQA' ? Permission.CHEQA_ER_Acceptance_CRITERIA_ADD : Permission.OQF_ER_Acceptance_CRITERIA_ADD;
