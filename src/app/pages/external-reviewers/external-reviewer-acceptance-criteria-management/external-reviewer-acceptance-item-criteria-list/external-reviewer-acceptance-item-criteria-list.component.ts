...
export class ExternalReviewerAcceptanceItemCriteriaListComponent implements OnInit, OnChanges, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.permissions = {
            VIEW:
                ...
                [Permission.OQF_ER_Acceptance_CRITERIA_VIEW],
            ADD:
                ...
                [Permission.OQF_ER_Acceptance_CRITERIA_ADD],
            UPDATE:
                ...
                [Permission.OQF_ER_Acceptance_CRITERIA_UPDATE],
            DELETE:
                ...
                [Permission.OQF_ER_Acceptance_CRITERIA_DELETE]
        };
            ...
            this.actions = [
                {
                    ...
                    show: () => this.hasPermission('UPDATE')
                }, {
    ...
    private hasPermission(action: keyof permissionsList): boolean {
        const required = this.permissions?.[action];
