...
import { VisitReportSummaryWizardService } from 'src/app/pages/school-performance/service/visit-report-summary-wizard.service';
...
@Component({
  selector: 'summary-appendices-step',
  templateUrl: './summary-appendices-step.component.html',
  styleUrl: './summary-appendices-step.component.scss'
})
export class SummaryAppendicesStepComponent extends BaseStepComponent{
