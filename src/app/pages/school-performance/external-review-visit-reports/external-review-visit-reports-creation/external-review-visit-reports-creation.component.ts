...
import {SchoolCommentsStepComponent} from './steps/school-comments-step/school-comments-step.component';
...
export class ExternalReviewVisitReportsCreationComponent implements OnInit, OnDestroy {
    ...
    schoolCommentsStepInputs = new Map<string, any>();
    mainRequestData: any;
    ...
    steps: StepItem[] = [
        ...
        },
        {
            ...
            component: SchoolCommentsStepComponent,
            inputs: this.schoolCommentsStepInputs
        },
        {
    ...
    ngOnInit(): void {
        // Subscribe to route params and query params to reload data when route changes
        // This allows reloading even when navigating to the same route with a query param
    ...
    private preparedStepsInputs() {
        ...
        this.schoolCommentsStepInputs.set('visitReportSubmissionRequestInfo', this.visitReportSubmissionRequestInfo);
        ...
        if (this.visitReportSubmissionRequestInfo.request?.id) {
            ...
            this.schoolCommentsStepInputs.set('isEditMode', false);
            ...
            this.schoolCommentsStepInputs.set('showSaveBtn', false);
        } else {
            ...
            this.schoolCommentsStepInputs.set('isEditMode', true);
            ...
            this.schoolCommentsStepInputs.set('showSaveBtn', true);
        }
