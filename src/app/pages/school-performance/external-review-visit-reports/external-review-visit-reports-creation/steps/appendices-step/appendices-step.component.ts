...
@Component({
  selector: 'appendices-step',
  templateUrl: './appendices-step.component.html',
  styleUrl: './appendices-step.component.scss'
})
export class AppendicesStepComponent extends BaseStepComponent {
