  ...
  private prepareGridHeaderCols() {
    this.columns = [
      ...
      },
      {
        ...
        valueGetter: (params: any) => this.translate.instant(`PAGES.COMMON.LABELS.${params.data.scheduledSchoolVisit.school.type}`)
      ...
      },
      {
        ...
        valueGetter: (params: any) => this.translate.instant(`PAGES.COMMON.LABELS.${params.data.scheduledSchoolVisit.school.gender.toUpperCase()}`)
      },
      {
      ...
      },
      {
        ...
        valueGetter: (params: any) => this.translate.instant(`PAGES.COMMON.LABELS.${params.data.status.toUpperCase()}`)
