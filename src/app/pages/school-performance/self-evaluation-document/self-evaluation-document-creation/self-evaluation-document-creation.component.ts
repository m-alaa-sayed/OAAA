...
export class SelfEvaluationDocumentCreationComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        // Subscribe to query params to reload data when reload query param is added
    ...
    initializeSchoolInfo(): SchoolInfo {
        return {
            id: '',
            schoolCommentsOnItsInfo: '',
            schoolCommentsOnStudentsInfo: '',
            schoolCommentsOnCountOfStaff: '',
            basicInfo: {
                id: '',
                schoolCode: '',
                arSchoolName: '',
     ...
     * Returns true only if visitStatus === 'WAITING_REPORT'
     */
    get shouldShowSchoolComments(): boolean {
        const scheduledVisit = this.selfEvaluationDocument.scheduledSchoolVisit;
        if (!scheduledVisit) {
            return false;
        }

        // Check if visitStatus is 'WAITING_REPORT'
        return scheduledVisit.visitStatus === 'WAITING_REPORT';
    }
}
