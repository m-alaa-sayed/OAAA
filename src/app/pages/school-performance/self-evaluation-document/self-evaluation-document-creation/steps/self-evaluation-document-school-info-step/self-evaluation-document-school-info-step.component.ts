...
@Component({
  selector: 'self-evaluation-document-school-info-step',
  templateUrl: './self-evaluation-document-school-info-step.component.html',
  styleUrl: './self-evaluation-document-school-info-step.component.scss'
})
export class SelfEvaluationDocumentSchoolInfoStepComponent extends BaseStepComponent {
