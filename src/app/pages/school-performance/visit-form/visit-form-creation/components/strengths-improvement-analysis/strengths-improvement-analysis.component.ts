...
@Component({
    selector: 'strengths-improvement-analysis',
    templateUrl: './strengths-improvement-analysis.component.html',
    styleUrl: './strengths-improvement-analysis.component.scss'
})
export class StrengthsImprovementAnalysisComponent implements OnInit {
