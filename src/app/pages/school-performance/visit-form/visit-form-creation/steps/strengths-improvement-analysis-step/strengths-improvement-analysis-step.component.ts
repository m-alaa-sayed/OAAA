...
@Component({
    selector: 'strengths-improvement-analysis-step',
    templateUrl: './strengths-improvement-analysis-step.component.html',
    styleUrl: './strengths-improvement-analysis-step.component.scss'
})
export class StrengthsImprovementAnalysisStepComponent extends BaseStepComponent {
