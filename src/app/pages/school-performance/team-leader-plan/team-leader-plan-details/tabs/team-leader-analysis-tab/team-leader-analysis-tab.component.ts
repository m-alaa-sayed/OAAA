...
@Component({
  selector: 'team-leader-analysis-tab',
  templateUrl: './team-leader-analysis-tab.component.html',
  styleUrl: './team-leader-analysis-tab.component.scss'
})
export class TeamLeaderAnalysisTabComponent extends BaseTabComponent {
