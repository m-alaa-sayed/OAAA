...
export class ImportVisitFormsComponent implements OnInit {
    ...
    columns = [
        ...
        {field: 'academicAchievement', label: 'PAGES.EXTERNAL_REVIEW_VISIT_REPORTS.LABELS.DOMAIN_EVALUATION_SCHOOL_COMMENTS_ON_ACADEMIC_ACHIEVEMENT', visible: true},
        {field: 'personalDevelopment', label: 'PAGES.EXTERNAL_REVIEW_VISIT_REPORTS.LABELS.DOMAIN_EVALUATION_SCHOOL_COMMENTS_ON_PERSONAL_DEVELOPMENT', visible: true},
        {field: 'teachingAssessment', label: 'PAGES.EXTERNAL_REVIEW_VISIT_REPORTS.LABELS.DOMAIN_EVALUATION_SCHOOL_COMMENTS_ON_TEACHING_AND_ASSESSMENT', visible: true},
        {field: 'learningEnvironment', label: 'PAGES.EXTERNAL_REVIEW_VISIT_REPORTS.LABELS.DOMAIN_EVALUATION_SCHOOL_COMMENTS_ON_LEARNING_ENVIRONMENT', visible: true},
        {field: 'leadershipGovernance', label: 'PAGES.EXTERNAL_REVIEW_VISIT_REPORTS.LABELS.DOMAIN_EVALUATION_SCHOOL_COMMENTS_ON_LEADERSHIP_AND_GOVERNANCE', visible: true}
    ];
