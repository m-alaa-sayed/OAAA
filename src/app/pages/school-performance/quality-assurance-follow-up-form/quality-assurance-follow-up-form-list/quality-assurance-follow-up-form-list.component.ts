...
export class QualityAssuranceFollowUpFormListComponent extends BaseModal implements OnInit {
    ...
    private prepareGridHeaderCols() {
        ...
        const download = {
            ...
            show: () => userPermissions.includes(Permission.QA_FOLLOW_UP_FORM_EXPORT_REPORT)
        };
        ...
        const details = {
            ...
            show: () => userPermissions.includes(Permission.QA_FOLLOW_UP_FORM_VIEW_DETAILS)
        };
        ...
        const deleteQaFrom = {
            ...
            show: () => userPermissions.includes(Permission.QA_FOLLOW_UP_FORM_DELETE)
        }

        this.actions = this.isReport ? [download] : [details, deleteQaFrom, download];
    }
