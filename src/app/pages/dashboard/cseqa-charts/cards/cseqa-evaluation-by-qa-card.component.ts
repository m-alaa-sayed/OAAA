...
import {
  ...
  DashboardCseqaQaEvaluationDistributionRow
...
@Component({
  selector: 'app-cseqa-evaluation-by-qa-card',
  templateUrl: './cseqa-evaluation-by-qa-card.component.html'
})
export class CseqaEvaluationByQACardComponent implements OnInit {
  ...
  tableData: DashboardCseqaQaEvaluationDistributionRow[] = [];
  ...
  private load(): void {
    this.dashboardService.getCseqaQaEvaluationDistribution().subscribe({
      next: (response: DashboardCseqaQaEvaluationDistributionResponse) => {
