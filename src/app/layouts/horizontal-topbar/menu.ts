...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        permissions: [Permission.MANAGE_SERVICE],
        subItems: [
            {
                id: 31,
    ...
    },
    {
        ...
        permissions: [Permission.CHEQA_ER_Acceptance_CRITERIA_MANAGE,
            ...
            Permission.CHEQA_ER_Withdraw_Requests_VIEW_ALL
        ],
        subItems: [
            {
                id: 51,
            ...
            },
            {
                ...
                subItems: [
                    ...
                    },
                    {
                        ...
                        roles: [],
                        permissions: [Permission.CHEQA_ER_Withdraw_Requests_VIEW_ALL]
                    },
                    {
                        id: 628,
                        parentId: 52,
                        label: 'MENUITEMS.MENU.DELETION_REQUESTS',
                        link: '/jawda/external-reviewers-deletion/creation/CHEQA',
...

    {
        ...
        permissions: [Permission.CSEQA_ER_Acceptance_CRITERIA_MANAGE,
            ...
            Permission.CSEQA_ER_Withdraw_Requests_VIEW_ALL
        ],
        subItems: [
            {
                id: 41,
                ...
                roles: [],
                permissions: [Permission.CSEQA_ER_Acceptance_CRITERIA_MANAGE, Permission.CSEQA_ER_registration_settings_MANAGE],
                subItems: [
                    {
                        id: 411,
            ...
            },
            {
                ...
                subItems: [
                    ...
                    },
                    {
                        ...
                        roles: [],
                        permissions: [Permission.CSEQA_ER_Training_results_Registration_Request_VIEW_ALL
                        ]
                    },
                    {
                        id: 422,
                    ...
                    },
                    {
                        ...
                        roles: [],
                        permissions: [Permission.CSEQA_ER_Withdraw_Requests_VIEW_ALL]
                    },
                    {
                        id: 628,
                        parentId: 52,
...

    {
        ...
        permissions: [Permission.OQF_ER_Acceptance_CRITERIA_MANAGE,
            ...
            Permission.OQF_ER_Withdraw_Requests_VIEW_ALL,
            Permission.OQF_ER_Registration_Request_VIEW_ALL
        ],
        subItems: [
            {
                id: 61,
                ...
                subItems: [
                    {
                        ...
                        roles: [],
                        permissions: [Permission.OQF_ER_Registration_Request_VIEW_ALL]
                    },
                    {
                        id: 623,
                        parentId: 62,
                    ...
                    },
                    {
                        ...
                        roles: [],
                        permissions: [Permission.OQF_ER_Withdraw_Requests_VIEW_ALL]
                    },
                    {
                        id: 628,
                        parentId: 52,
                        label: 'MENUITEMS.MENU.DELETION_REQUESTS',
                        link: '/jawda/external-reviewers-deletion/creation/OQF',
...

    {
        ...
        permissions: [Permission.SCHOOL_PERFORMANCE, Permission.VISIT_PLAN_VIEW, Permission.SELF_EVALUATION_DOCUMENT_VIEW,
            Permission.SELF_EVALUATION_DOCUMENT_VIEW_ALL, Permission.GENERAL_EVIDENCE_VISIT_FORM_VIEW, Permission.CLASSROOM_OBSERVATION_VISIT_FORM_VIEW,
            Permission.DOMAIN_SUMMARY_VIEW, Permission.QA_FOLLOW_UP_FORM_VIEW,
            Permission.SCHOOL_DOCUMENT_DELIVERY_VIEW, Permission.VISIT_REPORT_VIEW,
        ...
        subItems: [
            ...
            },
            {
                ...
                roles: [],
                permissions: [Permission.DOMAIN_SUMMARY_VIEW]
            },
            {
                id: 66,
                parentId: 7,
                ...
                roles: [],
                permissions: [Permission.QA_FOLLOW_UP_FORM_VIEW, Permission.SCHOOL_DOCUMENT_DELIVERY_VIEW],
                subItems: [
                    {
                        id: 661,
                        parentId: 66,
                    ...
                    },
                    {
                        ...
                        roles: [],
                        permissions: [Permission.SCHOOL_DOCUMENT_DELIVERY_VIEW]
                    },
                    {
                        id: 663,
                        parentId: 66,
