...
export const AppConstants: any = {
    ...
    API: {
        ...
        // Dashboard
        CSEQA_DASHBOARD_COUNTS_RATIOS: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/counts-ratios`,
        CSEQA_DASHBOARD_DISTRIBUTION_BY_STATUS: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/distribution-by-status`,
        CSEQA_DASHBOARD_YEAR_COMPARISON: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/year-comparison`,
        CSEQA_DASHBOARD_DISTRIBUTION_BY_SPECIALIZATION: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/distribution-by-specialization`,
        CSEQA_DASHBOARD_DISTRIBUTION_BY_COUNTRY: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/distribution-by-country`,
        CSEQA_DASHBOARD_ACTIVITIES_PARTICIPATION: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/activities-participation`,
        CSEQA_DASHBOARD_JOIN_REQUESTS_BY_STATUS: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/join-requests-by-status`,
        CSEQA_DASHBOARD_WITHDRAWAL_REQUESTS_BY_STATUS: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/withdrawal-requests-by-status`,
        CSEQA_DASHBOARD_DISTRIBUTION_BY_NATIONALITY: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/distribution-by-nationality`,
        CSEQA_DASHBOARD_DISTRIBUTION_BY_GOVERNORATE_WILAYAT: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/distribution-by-governorate-wilayat`,
        CSEQA_DASHBOARD_TEAM_LEADER_EVALUATION_DISTRIBUTION: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/team-leader-evaluation-distribution`,
        CSEQA_DASHBOARD_QA_EVALUATION_DISTRIBUTION: `${environment.baseURL}/oaaaqa/cseqa/v1/reviewers/dashboard/qa-evaluation-distribution`,

        DASHBOARD_COUNTS_RATIOS: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/counts-ratios`,
        DASHBOARD_DISTRIBUTION_BY_STATUS: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/distribution-by-status`,
        DASHBOARD_YEAR_COMPARISON: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/year-comparison`,
        DASHBOARD_DISTRIBUTION_BY_SPECIALIZATION: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/distribution-by-specialization`,
        DASHBOARD_DISTRIBUTION_BY_COUNTRY: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/distribution-by-country`,
        DASHBOARD_ACTIVITIES_PARTICIPATION: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/activities-participation`,
        DASHBOARD_JOIN_REQUESTS_BY_STATUS: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/join-requests-by-status`,
        DASHBOARD_WITHDRAWAL_REQUESTS_BY_STATUS: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/withdrawal-requests-by-status`,
        DASHBOARD_CANDIDATES_REGISTER: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/report/candidates-register`,
        DASHBOARD_REVIEWERS_REGISTER: `${environment.baseURL}/oaaaqa/cheqa/v1/reviewers/dashboard/report/reviewers-register`,
        DASHBOARD_OQF_COUNTS_RATIOS: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/counts-ratios`,
        DASHBOARD_OQF_DISTRIBUTION_BY_STATUS: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/distribution-by-status`,
        DASHBOARD_OQF_YEAR_COMPARISON: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/year-comparison`,
        DASHBOARD_OQF_DISTRIBUTION_BY_SPECIALIZATION: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/distribution-by-specialization`,
        DASHBOARD_OQF_DISTRIBUTION_BY_COUNTRY: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/distribution-by-country`,
        DASHBOARD_OQF_DISTRIBUTION_BY_EMPLOYER: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/distribution-by-employer`,
        DASHBOARD_OQF_ACTIVITIES_PARTICIPATION: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/activities-participation`,
        DASHBOARD_OQF_JOIN_REQUESTS_BY_STATUS: `${environment.baseURL}/oaaaqa/oqf/v1/reviewers/dashboard/join-requests-by-status`,
